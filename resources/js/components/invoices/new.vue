        ...
        <div class="modal__content">
            ...
            <div class="modal__items">
                <ul style="list-style: none;">
                    <li v-for="(item, i) in listProucucts" :key="item.id" style="display: grid;grid-template-columns: 30px 350px 15px;align-items: center;padding-bottom: 5px;">
                        <p>{{ i+1 }}</p>
...
<script setup>
    ...
    const getproducts = async () => {
        ...
        listProucucts.value = response.data.products
    }
